...
public class DerelictTowerPieces {
	...
	public static class Piece extends SimpleStructurePiece {
		...
		public Piece (StructureManager structureManager, CompoundTag tagCompound) {
			super(RegistryHandler.DERELICT_TOWER_PIECE, tagCompound);
			this.structurePart = new Identifier(tagCompound.getString("Template"));
