...
public class JungleTowerPieces {
	...
	private static final ImmutableMap<Identifier, BlockPos> CENTER_TOP_OFFSETS = ImmutableMap.of(JUNGLE_TOWER_TOP, new BlockPos(7, 28, 7), JUNGLE_TOWER_BOTTOM, new BlockPos(4, 31, 4));
	private static final ImmutableMap<Identifier, BlockPos> CORNER_RELATIVE_POSITIONS = ImmutableMap.of(JUNGLE_TOWER_TOP, new BlockPos(-3, 31, -3), JUNGLE_TOWER_BOTTOM, BlockPos.ORIGIN);
	...
	public static class Piece extends SimpleStructurePiece {
		...
		public Piece(StructureManager structureManager, CompoundTag compoundTag) {
			super(RegistryHandler.JUNGLE_TOWER_PIECE, compoundTag);
			this.structurePart = new Identifier(compoundTag.getString("Template"));
